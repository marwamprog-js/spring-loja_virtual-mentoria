...
import com.maltadev.mentoria.lojavirtual.enums.StatusContaPagar;
...
public class ContaPagar implements Serializable {
	...
	/**
	 * Eu sou a pessoa que tem que pagar
	 */
	...
	/**
	 * Para quem tenho que pagar
	 */
	@ManyToOne(targetEntity = Pessoa.class)
	@JoinColumn(name = "pessoa_forn_fk", nullable = false, foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "pessoa_forn_fk"))
